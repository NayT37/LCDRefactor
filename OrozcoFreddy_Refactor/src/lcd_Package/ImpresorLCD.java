...
/*
 * Codigo tomado de: https://github.com/pslcorp/lcdrefactor
 * Refactorizacion: Freddy Orozco
 * 
 * */
...
public class ImpresorLCD {
	...
	/**
	 * Metodo encargado de anadir una linea a la matriz de Impresion
	 * 
	 * @param matriz MatrizImp
	 * @param punto Punto Pivote
	 * @param posFija Posicion Fija
	 * @param size Tamano Segmento
	...
	/**
	 * Método encargado de inciar la matriz
	 */
	...
	/**
	 * Método encargado de imprimir la matriz
	 */
	 ...
	 * 
	 * @param comando Entrada que contiene el size del segmento de los digitos 
	...
	/**
	 * Método encargado de validar si una cadena es numerica
	 * @param cadena
	 * @return true si es una cadena numerica
	 */
